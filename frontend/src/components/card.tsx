        ...
        <>
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="bg-white rounded-md overflow-hidden relative shadow-md">
                    ...
                    <div className="p-4">
                        <h2 className="text-2xl text-green-400"> {item.name} </h2>
                        <div className="flex justify-between mt-4 mb-4 text-gray-500">
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="ml-1 lg:text-xl"> {item.cook_time_minutes}m </span>
                            </div>
                            <div className="flex items-center">
                                ...
                                <span className="ml-1 lg:text-xl"> {item.calories_per_serving} cal </span>
                            </div>
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
